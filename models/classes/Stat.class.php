...
class Stat extends Model {
    ...
    {
        $req = $this->getBDD()->prepare("SELECT (SELECT COUNT(*) FROM fg_entreprise) as nb_entreprise, (SELECT COUNT(*) FROM fg_effectif) as nb_effectif, (SELECT COUNT(*) FROM fg_formateur) as nb_formateur, (SELECT COUNT(*) FROM fg_opca) as nb_opca, (SELECT COUNT(*) FROM fg_organisme_formation) as nb_organisme_formation, (SELECT COUNT(*) FROM fg_programme) as nb_programme");
        $req->execute();
